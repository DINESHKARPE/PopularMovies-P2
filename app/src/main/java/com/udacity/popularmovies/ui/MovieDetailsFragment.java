...
import com.udacity.popularmovies.util.TMDbUtil;
...
public class MovieDetailsFragment extends BaseFragment implements
    ...
    private com.udacity.popularmovies.entity.Movie mMovie;
    ...
    public static MovieDetailsFragment newInstance(com.udacity.popularmovies.entity.Movie movie, boolean twoPane) {
        MovieDetailsFragment fragment = new MovieDetailsFragment();
        Bundle args = new Bundle();
        args.putParcelable(com.udacity.popularmovies.ui.BundleKeys.MOVIE, Movie.toParcelable(movie));
